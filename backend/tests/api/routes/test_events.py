...
def test_get_events(client: TestClient, normal_user_token_headers: dict[str, str], random_event):
    random_event()
...
def test_get_event_by_id(client: TestClient, normal_user_token_headers: dict[str, str], random_event):
    event, _ = random_event()
    event_id = event.id
    r = client.get(
...
def test_get_event_unauthorized(client: TestClient, normal_user_token_headers: dict[str, str], superuser_token_headers: dict[str, str], random_event):
    event, _ = random_event()
    event_id = event.id
    r = client.get(
