...
from app.models import Token, UserPublic, Message, NewPassword, UserUpdate
from app import crud
from app.utils import generate_password_reset_token, send_email, generate_reset_password_email, verify_password_reset_token
...
def recover_password(email: EmailStr, session: SessionDep):
    """
    Password Recovery
    """
